...
export default function CreateEntitieModal(props: IProps) {
  return (
    <Modal title="Create new entity" open={props.open} onCancel={props.onClose} footer={null}>
      <Form layout="vertical">
        <Row gutter={[12, 0]}>
          <Col xs={24}>
            <Form.Item label="Entitiename:" name="entityname" required>
              <Input />
            </Form.Item>
          </Col>
          <Col xs={24}>
